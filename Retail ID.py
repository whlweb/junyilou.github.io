...
def down(rtl): #rtl样例 092
	spr = "/R" + rtl + ".png" #spr样例 /R092.png
	sx = sbn + rtl + ".png" #sx样例 ~/Downloads/Retail/16_9/R092.png
	...
	if newsize != oldsize and newsize > 409600:
		...
		newlist = fb.read().replace((rtl + ","), ""); fb.close() #注意,不能空格替换
...
sbn = rpath + "Pictures/R" #~/Downloads/Retail/Pictures/R
