import os, sys, fileinput, urllib2, datetime
def filesize(url):
...
def down(rtl):
	...
	if newsize != oldsize and newsize > 409600:
		...
		g='","size":"'; h=str(newsize / 1024)+"KB"; m='"}'; n='}'
		o="'"; p=' https://api.instapush.im/v1/post'
		AppID = "585e4e62a4c48a05d607b545"; AppSecret = "a32883f25245516940ea6b9f9b80fa54"
		finalOut = a+AppID+b+AppSecret+c+d+e+es+f+g+h+m+n+o+p
		os.system(finalOut)
